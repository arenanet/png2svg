...
help = function(errText) {
    ...
    out("Convert & optimize a PNG into an SVG using an embedded jpeg + mask (v" + gui.App.manifest.version + ")");
    out("Usage:");
    out("    d:\\png2svg\\png2svg -f d:/image.png -q 0.7");
    out("Options: ");
